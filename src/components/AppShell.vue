...
const navigation = computed(() => [{ to: '/pos', label: 'Punto de venta', icon: ShoppingCart }, { to: '/ventas', label: 'Ventas', icon: ClipboardList }, { to: '/caja', label: 'Caja', icon: CircleDollarSign }, ...(isAdmin.value ? [{ to: '/clientes', label: 'Clientes', icon: Users }, { to: '/inventario', label: 'Inventario', icon: Boxes }, { to: '/reportes', label: 'Reportes', icon: BarChart3 }, { to: '/actividad', label: 'Actividad', icon: History }, { to: '/usuarios', label: 'Usuarios', icon: Users }] : [])]);
