...
const routes = [
  ...
  { path: '/dashboard', name: 'dashboard', component: () => import('../views/ReportesView.vue'), meta: { requiresAuth: true, requiresAdmin: true, title: 'Resumen ejecutivo' } },
  ...
  { path: '/reportes', redirect: '/dashboard' },
...
router.beforeEach((to) => {
  ...
  if (to.name === 'login' && isAuthenticated.value) return { name: isAdmin.value ? 'dashboard' : 'pos' };
